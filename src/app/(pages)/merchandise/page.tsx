...
const page = () => {
  return (
    <div>
        ...
        <Navbar></Navbar>
        <div className="mt-10 mx-auto rounded-xl w-72 lg:w-1/2 bg-white shadow-xl">
    ...
    <div className="text-base font-light ml-10 mr-10 mt-6">
     ...
     Work remotely with your team. Buy mugs for every member, or the week's high scorer. Available via our online store on Redbubble. 
    </div>
